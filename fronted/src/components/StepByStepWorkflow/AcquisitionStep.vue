<template>
  <div class="acquisition-step">
    <StepDescription 
      text="Collect data related to public events from social media platforms. The system will automatically parse and normalize the collected data for further processing. You can click the button below to view the data sample."
    />
    <el-button type="primary" class="downloadButton" @click="downloadSample">
      Download Sample<el-icon class="el-icon--right"><Download /></el-icon>
    </el-button>
    ...
    <div class="acquisition-content">
      <div class="upload-zone">
        <label class="upload-label">
          ...
          <h4 class="upload-title">Upload Dataset</h4>
