<template>
  <div class="embedding-step">
    <StepDescription 
      text="Pre-training the auto-learning layer to convert raw feature vectors into a compact, robust, and informative latent representation by automatically reducing the influence of non-informative features under varying temporal contexts."
    />
      ...
      <div v-if="stepStatus === 'pending'" class="action-card">
        ...
        <div class="input-group">
          ...
          <input
            ...
            :min="min_WindowSize"
            :max="max_WindowSize"
            placeholder="Please input windowSize"
            required
          >
        </div>
        ...
        <div class="result-container">
          <div class="result-content">
            ...
            <p class="result-description">
              The auto-learning layer has been successfully pre-trained. The layer is ready to participate in the Fine-tuning.
            </p>
...
try {
  ...
  link.download = 'preTrain_FeatureSelector.pth'  // 下载文件名
